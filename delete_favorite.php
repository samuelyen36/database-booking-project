...
if(isset($_SESSION['account']))
{
    ...
    echo "$id_of_house<br>$id_of_user<br>";

    $sql="delete from favorite where house_id= ? and user_id = ?";
    $pre=$conn->prepare($sql);
    $pre->bind_param("ii",$id_of_house,$id_of_user);
    if($pre->execute()){
        echo "update successfully<br><br>";
        echo '<meta http-equiv=REFRESH CONTENT=3;url=favorite.php>';
    }
    else {
