...
$dbpassword = "10271027";
$dbname = "yenst_cs_hw3";
$info_name=$_POST["information_name"];
...
$sql_check = "select id from information_name where name = ? ";
...
if(mysqli_num_rows($result)!=0){
	echo "<div style ='font:50px/50px ;color:#ff0000'> <font size='18'> this information has the same name with another information ，母湯喔 </div> </font>\n\n\n";
	echo '<meta http-equiv=REFRESH CONTENT=4;url=add_information.php>';
}

else{
$sql="INSERT INTO information_name (name)VALUES(?)";
